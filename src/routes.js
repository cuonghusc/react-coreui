...
const CreateStudent = React.lazy(()=>import('./views/students/CreateStudent'));
...
const routes = [
  ...
  { path :'/students', exact:true, name:'Students List', component:Students },
  { path: '/students/:id', exact: true, name: 'Student Details', component: Student },
  { path: '/student/create', exact: true, name: 'Add New Student', component: CreateStudent },

  { path :'/products', exact:true, name:'Products List', component:Products },
  { path: '/products/:id', exact: true, name: 'Product Details', component: Product },
  { path: '/product/create', exact: true, name: 'Add New Product', component: CreateProduct },
];
